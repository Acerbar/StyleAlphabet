...
if(window.innerWidth > 1129.99){
    setTimeout(function(){block_1.classList.add("intro__block_active")}, 2800);
    setTimeout(function (){ block_2.classList.add("intro__block_active") }, 2000);
...
tabLinks.forEach(item => {
    item.addEventListener('click', (e) => {
        tabLinks.forEach(el => { el.classList.remove('tab__link_active'); });
